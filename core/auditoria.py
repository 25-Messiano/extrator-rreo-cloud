...
STATUS_VALIDOS = {"OK", "PARCIAL", "ERRO", "MUNICÍPIO NÃO ENCONTRADO", "SEM PDF FORNECIDO"}
...
RREO_LOG_HEADERS = [
    ...
    "Município no conteúdo", "Origem da identificação",
    "Confiança da identificação", "Divergência de município",
    "Ação adotada", "Campos RREO preenchidos",
