...
def carregar_municipios_da_planilha(
    ...
    for row in range(PRIMEIRA_LINHA_DADOS, worksheet.max_row + 1):
        ...
        # A matriz histórica traz Brasília/DF com o código estadual "53". Para
        # o processamento municipal, usa-se o código IBGE municipal 5300108
        # somente na linha de Brasília; a linha agregada Distrito Federal/DF
        # permanece fora da fila municipal.
        if uf == "DF" and codigo == "53" and ente.upper().startswith("BRASÍLIA/DF"):
            codigo = "5300108"
