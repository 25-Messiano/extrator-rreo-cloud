...
def _first_admin_dialog(db: AuthDatabase) -> None:
    ...
    st.markdown(
        '<div class="auth-version">Extrator RREO Cloud &nbsp;•&nbsp; versão 1.2.4</div>'
...
def _login_dialog(db: AuthDatabase) -> None:
    ...
    st.markdown('<div class="auth-version">Extrator RREO Cloud • versão 1.2.4</div>', unsafe_allow_html=True)
