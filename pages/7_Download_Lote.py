...
st.markdown('<div class="footerbar">📦 PDFs + Planilhas processadas &nbsp;•&nbsp; Estado ou Brasil inteiro &nbsp;•&nbsp; Originais preservados &nbsp;•&nbsp; v1.3.7.2 RREO SAFE STRUCTURAL</div>',unsafe_allow_html=True)
