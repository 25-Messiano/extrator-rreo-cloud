...
def apply_theme() -> None:
    st.markdown(
        ...
        div[data-testid="stDialog"] > div[role="dialog"]{border-radius:22px!important;border:1px solid rgba(214,223,238,.95)!important;box-shadow:0 30px 90px rgba(6,18,45,.28)!important;padding:8px 14px 14px!important;max-width:720px!important;}
...
def render_sidebar() -> None:
    with st.sidebar:
        ...
        st.markdown(
            ...
            <div style="margin-top:34px;font-size:10px;color:#8391ae!important">VERSÃO</div><div style="font-size:12px;margin-top:5px">v1.2.1</div>
            """,
            unsafe_allow_html=True,
        )
