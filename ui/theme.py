...
def apply_theme() -> None:
    st.markdown(
        ...
        .first-access-head{text-align:center;margin:0 0 14px}.first-access-lock{width:42px;height:42px;border-radius:12px;margin:0 auto 8px;background:linear-gradient(135deg,#1764ef,#2f6df4);color:#fff;display:flex;align-items:center;justify-content:center;font-size:20px;box-shadow:0 8px 20px rgba(47,91,234,.26)}.first-access-title{font-size:23px;font-weight:850;color:#12213a}.first-access-line{width:54px;height:3px;background:#1f66f2;border-radius:999px;margin:10px auto 0}.first-access-welcome{text-align:center;color:#526079;font-size:12px;line-height:1.48;margin:0 0 15px}.first-access-welcome strong{color:#1764ef;font-size:13px}.stDialog label p{font-size:11px!important;font-weight:750!important;color:#24324a!important}.stDialog input::placeholder{color:#9aa7bb!important;opacity:1!important}.stDialog input{min-height:42px!important}.password-box{background:#f4f7ff!important;border-color:#d9e3fb!important}.password-box-title{color:#2459c8!important}.stDialog button[kind="primary"]{background:linear-gradient(90deg,#1764ef,#1f6df4)!important;box-shadow:0 8px 18px rgba(31,102,242,.22)!important;font-size:13px!important}.stDialog button[kind="primary"]:hover{filter:brightness(1.04)}.auth-version{border-top:1px solid #e6eaf1;padding-top:12px!important;margin-top:14px!important}.setup-required-note{margin:12px 0 0;background:#263247;color:#fff;border:1px solid #f0a526;border-radius:9px;padding:10px 12px;font-size:10.5px;line-height:1.35;box-shadow:0 8px 18px rgba(15,23,42,.16)}
        </style>
        """,
...
def render_sidebar() -> None:
    with st.sidebar:
        ...
        st.markdown(
            ...
            <div style="margin-top:34px;font-size:10px;color:#8391ae!important">VERSÃO</div><div style="font-size:12px;margin-top:5px">v1.2.2</div>
            """,
            unsafe_allow_html=True,
        )
